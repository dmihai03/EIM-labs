...
public class GoogleMapsActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private class AddPlaceButtonListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            // TODO exercise 6a
            // check whether latitude, longitude and name are filled, otherwise log an error
            if (latitudeEditText.getText().toString().isEmpty() ||
                    latitudeEditText.getText().toString().isEmpty()) {
                Log.e("[AddPlaceButtonListener]", "onClick: no Lat or Long set");
            }
            ...
            marker.title(nameEditText.getText().toString());
            ...
            places.add(new Place(latitude, longitude,
                    nameEditText.getText().toString(),
                    markerTypeSpinner.getSelectedItemPosition()));
    ...
    private class ClearPlacesButtonListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (places.isEmpty()) {
                Log.e("[ClearPlacesButtonListener", "onClick: no markers on the map");
            }
