...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        boolean isChecked = ((CheckBox)findViewById(R.id.remember_me_checkbox)).isChecked();
        if (isChecked) {
    ...
    protected void onRestoreInstanceState(Bundle inState) {
        ((EditText)findViewById(R.id.username_edit_text)).setText(inState.getString(Constants.USERNAME_EDIT_TEXT));
        ((EditText)findViewById(R.id.password_edit_text)).setText(inState.getString(Constants.PASSWORD_EDIT_TEXT));
        ((CheckBox)findViewById(R.id.remember_me_checkbox)).setChecked(inState.getBoolean(Constants.REMEMBER_ME_CHECKBOX));
    }
}
